...
const projects = [
  {
    ...
    livePreview: null,
    description: "Tayssir POS (Point of Sale) Software is a comprehensive and efficient solution for managing sales, inventory, and customer interactions. Built with modern technologies such as Electron.js, React.js, Shadcn, Sequelize, and PostgreSQL, it provides a seamless experience for businesses of all sizes.",
    technologies: ["Electron js", "React", "Sqlite", "Sequelize ORM", 'Shadcn'],
    screenshots: [],
    bgColor: "#881337",
  },
  {
