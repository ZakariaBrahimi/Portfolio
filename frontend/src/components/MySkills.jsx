        ...
        <div className="grid grid-cols-2 justify-between gap-5">
          <div className="flex flex-col gap-2 mt-6 col-span-1">
            ...
            <p className=" opacity-45 font-medium">
              ...
              opportunity to benefit from professional consultations by the best
              Algerian and international specialists in various fields{" "}
            </p>
          </div>
          <div className="flex flex-col gap-2 mt-6">
            <p className=" font-semibold text-green-500">
            ...
            <p className=" font-semibold text-xl">
              Product Manager & Fullstack developer - Sena Research (Remote)
            </p>
            <p className=" opacity-45 font-medium">
              It's an educational platform connecting university students with
              top-notch professors, doctors, and professionals for high-quality
              assistance, quickly. Acting as a bridge between students and
              educators{" "}
            </p>
          </div>
          <div className="flex flex-col gap-2 mt-6">
