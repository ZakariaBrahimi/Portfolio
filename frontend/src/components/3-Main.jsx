  ...
  return (
    <div className="">
      ...
      <ol id="experience" className=" pt-12">
        ...
        <p className="flex items-center justify-center gap-3 py-4 w-10/12 mx-auto bg-[#ffffff0f] mb-12 rounded-xl text-center ">
          <svg
            viewBox="0 0 24 24"
            focusable="false"
            className=" w-4 h-4"
          ...
          <a
            ...
            className=" underline font-semibold hover:text-darkGreen transition-colors"
